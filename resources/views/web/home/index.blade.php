                    ...
                    <div class="container text-center wow fadeIn">
                        <div class="row d-flex justify-content-center align-items-center">
                            <div class="col-md-12 col-lg-12 text-white">
                                <h2 class="h1-responsive font-weight-bold text-center">{{ $info->title }}</h2>
                                <br>
...
<section class="view parallax-servicios-bg" style="background-image: url({{ asset('storage/images/cliente.jpeg')}});">
    <div class="mask flex-center rgba-black-light">
    </div>
</section>
<section class="container-fluid bg-section-nosotros text-white">
    <div class="row d-flex justify-content-center align-items-center pt-2 pb-2">
        <div class="col-md-10 mt-2 mb-4">
            <h2 class="h2-responsive text-center font-weight-bold wow fadeInUp mt-3 mb-5">Nuestra Empresa</h2>
